...
if __name__ == "__main__":
    ...
    parser.add_argument("--weight_path", type=str, default="/home/arpitsah/Desktop/Fall-2023/VLR/project/frame-interpolation-VLR/emavfi/ckpt/ours_small_ours_small_t_100+_9.pkl")
    ...
    if len(args.weight_path)!=0:
        model.net.load_state_dict(convert(torch.load(args.weight_path, map_location=model.device)))
